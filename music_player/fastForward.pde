...
void fastForwardSetup() {
  ...
  fastForwardWidth =displayWidth*1/10;
...
void fastForwardMousePressed() {
  if (mouseX>fastForwardX && mouseX<fastForwardX+fastForwardWidth && mouseY>fastForwardY && mouseY< fastForwardY+fastForwardHeight) song1.skip(240000);
